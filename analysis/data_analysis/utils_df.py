...
def references_2024 (dataframe):
    ...
    full_df = dataframe.copy()
    full_df.loc[full_df['Reference'].str.contains('03A4C_3rB'), 'Reference'] = full_df['Reference'].str.replace('03A4C_3rB', '3rB')
    full_df.loc[full_df['Reference'].str.contains('03A52_2nD'), 'Reference'] = full_df['Reference'].str.replace('03A52_2nD', '2nD')
    full_df.loc[full_df['Reference'].str.contains('03A48_4tE'), 'Reference'] = full_df['Reference'].str.replace('03A48_4tE', '4tE')
    full_df.loc[full_df['Reference'].str.contains('0E8DF_Sal'), 'Reference'] = full_df['Reference'].str.replace('0E8DF_Sal', 'Sala de Profes')
    full_df.loc[full_df['Reference'].str.contains('03AAB_2nE'), 'Reference'] = full_df['Reference'].str.replace('03AAB_2nE', '2nE')
    full_df.loc[full_df['Reference'].str.contains('0E755_1rC'), 'Reference'] = full_df['Reference'].str.replace('0E755_1rC', '1rC')
    full_df.loc[full_df['Reference'].str.contains('03A4D_Sem'), 'Reference'] = full_df['Reference'].str.replace('03A4D_Sem', 'Seminari')
    full_df.loc[full_df['Reference'].str.contains('0E9F5_3rD'), 'Reference'] = full_df['Reference'].str.replace('0E9F5_3rD', '3rD')
    full_df.loc[full_df['Reference'].str.contains('03A8C_Bib'), 'Reference'] = full_df['Reference'].str.replace('03A8C_Bib', 'Biblioteca')
    full_df.loc[full_df['Reference'].str.contains('03A4E_mú'), 'Reference'] = full_df['Reference'].str.replace('03A4E_mú', 'Música')
    full_df.loc[full_df['Reference'].str.contains('03A4D_sem'), 'Reference'] = full_df['Reference'].str.replace('03A4D_sem', 'Seminari')
    full_df.loc[full_df['Reference'].str.contains('03A8C_bib'), 'Reference'] = full_df['Reference'].str.replace('03A8C_bib', 'Biblioteca')
    full_df.loc[full_df['Reference'].str.contains('03A4E_mus'), 'Reference'] = full_df['Reference'].str.replace('03A4E_mus', 'Música')
    full_df.loc[full_df['Reference'].str.contains('0E8DF_sal'), 'Reference'] = full_df['Reference'].str.replace('0E8DF_sal', 'Sala de Profes')
    return full_df
